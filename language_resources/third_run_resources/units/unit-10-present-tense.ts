    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          id: 'ex-10-3-9',
          type: 'translation',
          question: 'Translate: ⲧⲉⲧⲛⲙⲉⲛⲣⲉ ⲙⲫϯ',
          questionCoptic: 'ⲧⲉⲧⲛⲙⲉⲛⲣⲉ ⲙⲫϯ',
          correctAnswer: 'you (pl) love God',
          options: ['you (pl) love God', 'we love God', 'they love God', 'I love God'],
          explanation: 'ⲧⲉⲧⲛⲙⲉⲛⲣⲉ ⲙⲫϯ = you (pl) love God (Bohairic: ⲙⲉⲛⲣⲉ not ⲙⲉⲣⲓ, ⲫϯ not ⲫⲛⲟⲩϯ)'
        },
        {
          id: 'ex-10-3-10',
          type: 'multiple_choice',
          question: 'How do you say "she knows"?',
          correctAnswer: 'ⲥⲉ̀ⲙⲓ',
          options: ['ⲥⲉ̀ⲙⲓ', 'ϥⲉ̀ⲙⲓ', 'ϯⲉ̀ⲙⲓ', 'ⲧⲉⲉ̀ⲙⲓ'],
          explanation: 'ⲥⲉ̀ⲙⲓ = ⲥ (she, present) + ⲉ̀ⲙⲓ (know) = "she knows"'
        }
      ]
    },
    {
      id: 'lesson-10-4',
      unitId: 'unit-10',
      title: 'Present Tense in Complex Sentences',
      description: 'Present with multiple verbs, prepositions, and continuous vs habitual',
      order: 4,
      xpReward: 25,
      isLocked: true,
      completed: false,
      exercises: [
        {
          id: 'ex-10-4-1',
          type: 'translation',
          question: 'Translate: ϯⲙⲟϣⲓ ⲉ̀ϯⲉⲕⲕⲗⲏⲥⲓⲁ ⲛ̀ⲥⲁⲃⲃⲁⲧⲟⲛ ⲛⲓⲃⲉⲛ',
          questionCoptic: 'ϯⲙⲟϣⲓ ⲉ̀ϯⲉⲕⲕⲗⲏⲥⲓⲁ ⲛ̀ⲥⲁⲃⲃⲁⲧⲟⲛ ⲛⲓⲃⲉⲛ',
          correctAnswer: 'I go to church every week',
          options: ['I go to church every week', 'I went to church every week', 'I will go to church every week', 'I am going to church'],
          explanation: 'ϯⲙⲟϣⲓ ⲉ̀ϯⲉⲕⲕⲗⲏⲥⲓⲁ = I go to church + ⲛ̀ⲥⲁⲃⲃⲁⲧⲟⲛ ⲛⲓⲃⲉⲛ = every week (habitual present)'
        },
        {
          id: 'ex-10-4-2',
          type: 'multiple_choice',
          question: 'Which sentence shows continuous present?',
          correctAnswer: 'ϯⲥⲁϫⲓ ⲛⲉⲙⲁⲕ ϯⲛⲟⲩ',
          options: ['ϯⲥⲁϫⲓ ⲛⲉⲙⲁⲕ ϯⲛⲟⲩ', 'ϯⲥⲁϫⲓ ⲛⲉⲙⲁⲕ ⲙ̀ⲙⲏⲛⲓ', 'ⲁⲓⲥⲁϫⲓ ⲛⲉⲙⲁⲕ', 'ϯⲛⲁⲥⲁϫⲓ ⲛⲉⲙⲁⲕ'],
          explanation: 'ϯⲥⲁϫⲓ ⲛⲉⲙⲁⲕ ϯⲛⲟⲩ = I speak with you now (continuous - happening right now)'
        },
        {
          id: 'ex-10-4-3',
          type: 'matching',
          question: 'Match present tense with prepositional phrases',
          correctAnswer: 'matched',
          pairs: [
            { coptic: 'ϯⲥⲱⲧⲙ ⲉ̀ⲣⲟⲕ', english: 'I listen to you' },
            { coptic: 'ⲕⲙⲟϣⲓ ⲛⲉⲙⲏⲓ', english: 'you (m) walk with me' },
            { coptic: 'ⲥϫⲱ ⲙ̀ⲡⲓⲥⲁϫⲓ', english: 'she speaks the word' },
            { coptic: 'ⲧⲉⲛⲥⲱⲧⲙ ⲉ̀ⲣⲱⲟⲩ', english: 'we listen to them' }
          ]
        },
        {
          id: 'ex-10-4-4',
          type: 'translation',
          question: 'Translate: ϥⲟⲩⲱⲙ ⲟⲩⲟϩ ϥⲥⲱ',
          questionCoptic: 'ϥⲟⲩⲱⲙ ⲟⲩⲟϩ ϥⲥⲱ',
          correctAnswer: 'he eats and drinks',
          options: ['he eats and drinks', 'he ate and drank', 'he will eat and drink', 'he is eating and drinking'],
          explanation: 'ϥⲟⲩⲱⲙ ⲟⲩⲟϩ ϥⲥⲱ = he eats and he drinks (multiple verbs in present - Bohairic ⲟⲩⲟϩ = and)'
        },
        {
          id: 'ex-10-4-5',
          type: 'sentence_building',
          question: 'Build: "We read and write every day"',
          correctAnswer: 'ⲧⲉⲛⲱϣ ⲟⲩⲟϩ ⲧⲉⲛⲥ̀ϧⲁⲓ ⲙ̀ⲙⲏⲛⲓ',
          wordBank: ['ⲧⲉⲛ', 'ⲱϣ', 'ⲟⲩⲟϩ', 'ⲥ̀ϧⲁⲓ', 'ⲙ̀ⲙⲏⲛⲓ'],
          explanation: 'ⲧⲉⲛⲱϣ ⲟⲩⲟϩ ⲧⲉⲛⲥ̀ϧⲁⲓ ⲙ̀ⲙⲏⲛⲓ = we read and we write every day (habitual present)'
        },
        {
          id: 'ex-10-4-6',
          type: 'fill_blank',
          question: 'Complete: ϯⲛⲁⲩ ⲉ̀ⲣⲟⲕ ___ = I see you (now, continuous)',
          correctAnswer: 'ϯⲛⲟⲩ',
          options: ['ϯⲛⲟⲩ', 'ⲙ̀ⲙⲏⲛⲓ', 'ⲛⲓⲃⲉⲛ', 'ⲙ̀ⲫⲟⲟⲩ'],
          explanation: 'ϯⲛⲟⲩ = now (indicates continuous present action happening right now)'
        },
        {
          id: 'ex-10-4-7',
          type: 'multiple_choice',
          question: 'What does ⲥⲉⲟⲩⲱⲙ ⲟⲩⲟϩ ⲥⲉⲥⲱ ⲟⲩⲟϩ ⲥⲉⲣⲁϣⲓ mean?',
          questionCoptic: 'ⲥⲉⲟⲩⲱⲙ ⲟⲩⲟϩ ⲥⲉⲥⲱ ⲟⲩⲟϩ ⲥⲉⲣⲁϣⲓ',
          correctAnswer: 'They eat and drink and rejoice',
          options: ['They eat and drink and rejoice', 'They ate and drank and rejoiced', 'They will eat and drink', 'They are eating'],
          explanation: 'ⲥⲉⲟⲩⲱⲙ ⲟⲩⲟϩ ⲥⲉⲥⲱ ⲟⲩⲟϩ ⲥⲉⲣⲁϣⲓ = series of present tense verbs (habitual actions)'
        },
        {
          id: 'ex-10-4-8',
          type: 'translation',
          question: 'Translate: ⲕⲉ̀ⲙⲓ ϫⲉ ϯⲙⲉⲛⲣⲉ ⲙⲙⲟⲕ',
          questionCoptic: 'ⲕⲉ̀ⲙⲓ ϫⲉ ϯⲙⲉⲛⲣⲉ ⲙⲙⲟⲕ',
          correctAnswer: 'you (m) know that I love you',
          options: ['you (m) know that I love you', 'I know that you love me', 'you knew that I loved you', 'I love you'],
          explanation: 'ⲕⲉ̀ⲙⲓ ϫⲉ = you know that + ϯⲙⲉⲛⲣⲉ ⲙⲙⲟⲕ = I love you (present in subordinate clause)'
        },
        {
          id: 'ex-10-4-9',
          type: 'sentence_building',
          question: 'Build: "She comes and sits with us"',
          correctAnswer: 'ⲥⲓ̀ ⲟⲩⲟϩ ⲥϩⲉⲙⲥⲓ ⲛⲉⲙⲁⲛ',
          wordBank: ['ⲥ', 'ⲓ̀', 'ⲟⲩⲟϩ', 'ϩⲉⲙⲥⲓ', 'ⲛⲉⲙⲁⲛ'],
          explanation: 'ⲥⲓ̀ ⲟⲩⲟϩ ⲥϩⲉⲙⲥⲓ ⲛⲉⲙⲁⲛ = she comes and she sits with us (present + prepositional phrase)'
        },
        {
          id: 'ex-10-4-10',
          type: 'translation',
          question: 'Translate to Coptic: "I walk to the house every day"',
          correctAnswer: 'ϯⲙⲟϣⲓ ⲉ̀ⲡⲓⲏⲓ ⲙ̀ⲙⲏⲛⲓ',
          options: ['ϯⲙⲟϣⲓ ⲉ̀ⲡⲓⲏⲓ ⲙ̀ⲙⲏⲛⲓ', 'ⲁⲓⲙⲟϣⲓ ⲉ̀ⲡⲓⲏⲓ', 'ϯⲙⲟϣⲓ ⲙ̀ⲙⲏⲛⲓ', 'ϯⲙⲟϣⲓ ⲉ̀ⲡⲓⲏⲓ ϯⲛⲟⲩ'],
          explanation: 'ϯⲙⲟϣⲓ ⲉ̀ⲡⲓⲏⲓ ⲙ̀ⲙⲏⲛⲓ = I walk to the house every day (habitual present with time expression)'
        }
      ]
    }
  ]
