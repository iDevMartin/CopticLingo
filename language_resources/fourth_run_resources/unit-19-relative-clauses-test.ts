...
// TEST FILE FOR UNIT 19: RELATIVE CLAUSES
// Comprehensive test exercises covering all 4 lessons
// 32 exercises total - testing all relative forms and tenses

const unit19Test: Unit = {
  id: 'unit-19-test',
  title: 'Unit 19 Test: Relative Clauses',
  description: 'Comprehensive test of relative constructions',
  order: 19.5,
  color: '#00CD9C',
  lessons: [
    {
      id: 'lesson-19-test',
      unitId: 'unit-19-test',
      title: 'Relative Clauses Comprehensive Test',
      description: 'Test all relative forms: present, past, future, negative',
      order: 1,
      xpReward: 100,
      isLocked: true,
      completed: false,
      exercises: [
        // Present Relatives tests
        {
          id: 'test-19-1',
          type: 'translation',
        ...
        },
        {
          id: 'test-19-5',
          type: 'matching',
          question: 'Match nouns with present relatives',
