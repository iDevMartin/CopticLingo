...
// Real, hypothetical, and contrary-to-fact conditions
  ...
  lessons: [
    {
      id: 'lesson-22-1',
      unitId: 'unit-22',
      title: 'Real Conditions (ⲓϣϫⲉ)',
      description: 'If... then... (likely/real)',
      order: 1,
      xpReward: 30,
      isLocked: true,
      completed: false,
      exercises: [
        ...
        },
        {
          id: 'ex-22-1-3',
          type: 'matching',
          question: 'Match conditional parts',
    ...
    },
    {
      id: 'lesson-22-2',
      unitId: 'unit-22',
      title: 'Alternative Conditions (ⲉϣⲱⲡ)',
      description: 'If/when... (alternative marker)',
      order: 2,
      xpReward: 30,
      isLocked: true,
      completed: false,
    ...
    },
    {
      id: 'lesson-22-3',
      unitId: 'unit-22',
      title: 'Unless & Negative Conditions',
      description: 'Expressing negative conditions',
      order: 3,
      xpReward: 30,
      isLocked: true,
      completed: false,
    ...
    },
    {
      ...
      description: 'Hypothetical past (if X had happened...)',
      order: 4,
      xpReward: 30,
      isLocked: true,
      completed: false,
