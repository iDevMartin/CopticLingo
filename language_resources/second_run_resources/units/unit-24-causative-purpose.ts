...
// UNIT 24: CAUSATIVE & PURPOSE CLAUSES
// Verified for Bohairic dialect consistency
// Teaching causative verbs (ⲧⲁⲙⲟ, ⲑⲣⲉ) and purpose with ϩⲓⲛⲁ

const unit24: Unit = {
  id: 'unit-24',
  title: 'Causative & Purpose',
  description: 'Learn to express cause, making someone do something, and purpose',
  order: 24,
  color: '#1CB0F6',
  lessons: [
    {
    ...
    },
    {
      id: 'lesson-24-2',
      unitId: 'unit-24',
      title: 'Causative with ⲑⲣⲉ-',
      description: 'Another way to express causation',
      order: 2,
      xpReward: 40,
      isLocked: true,
      completed: false,
    ...
    },
    {
      id: 'lesson-24-3',
      unitId: 'unit-24',
      title: 'Purpose with ϩⲓⲛⲁ',
      description: 'Express "in order to" or "so that"',
      order: 3,
      xpReward: 40,
      isLocked: true,
      completed: false,
    ...
    },
    {
      id: 'lesson-24-4',
      unitId: 'unit-24',
      title: 'Result Clauses - ϩⲱⲥⲧⲉ',
      description: 'Express result or consequence',
      order: 4,
      xpReward: 40,
      isLocked: true,
      completed: false,
