...
1. crum.json: a Coptic-English dictionary in HTML format that contains the words in Coptic in different dialects. The major ones that you should care about the most is Bohairic (indicated with 😎 and Sahidic (indicated with S). You can ignore all other dialects.
...
For full examples, I'm attaching the New Testament, verse by verse in English, Greek, Bohairic and Sahidic. Also Genesis in Bohairic, Hebrew and English.
